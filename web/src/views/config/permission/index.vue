  ...
  tableConfig: [
    {
      ...
      tools: [
        ...
        },
        {
          ...
          click() {
            return Service.config.permission.remove(ids()).then((res: any) => {
        ...
        },
        {
          ...
          api(files: any) {
            return Service.config.permission.imports(files).then((res: any) => {
        ...
        },
        {
          ...
          api() {
            return Service.config.permission.exports(unref(pageData).queryData);
          },
      ...
      actions: [
        {
          ...
          click({ row }: any) {
            return Service.config.permission
              .detail({ id: row.id })
              .then((res: any) => {
                unref(pageRef).handleOpen({
                  type: "edit",
      ...
      query: (pages: any) =>
        Service.config.permission.page({
          ...pages,
          ...pageData.queryData,
        }),
    },
