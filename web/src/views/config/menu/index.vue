  ...
  tableConfig: [
    {
      ...
      tools: [
        ...
        },
        {
          ...
          click() {
            Service.config.menu.remove(ids()).then((res: any) => {
        ...
        },
        {
          ...
          api(files: any) {
            return Service.config.menu.imports(files).then((res: any) => {
        ...
        },
        {
          ...
          api() {
            return Service.config.menu.exports(pageData.queryData);
          },
      ...
      actions: [
        ...
        },
        {
          ...
          click({ row }: any) {
            Service.config.menu.detail({ id: row.id }).then((res: any) => {
              unref(pageRef).handleOpen({
                type: "edit",
                data: res.data,
              });
        ...
        },
        {
          ...
          permission: ["menu:remove"],
          click({ row }: any) {
            Service.config.menu.remove([row.id]).then((res: any) => {
              removeSuccess(res, pageRef);
            });
          },
        },
      ...
      list: () => {
        return Service.config.menu.list(pageData.queryData).then((res: any) => {
