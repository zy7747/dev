  ...
  tableConfig: [
    {
      ...
      tools: [
        ...
        },
        {
          ...
          click() {
            return Service.config.job.remove(ids()).then((res: any) => {
        ...
        },
        {
          ...
          api(files: any) {
            return Service.config.job.imports(files).then((res: any) => {
      ...
      actions: [
        ...
        },
        {
          ...
          permission: ["job:remove"],
          click({ row }: any) {
            return Service.config.job.remove([row.id]).then((res: any) => {
              removeSuccess(res, pageRef);
            });
          },
        },
      ...
      query: (pages: any) =>
        Service.config.job.page({ ...pages, ...pageData.queryData }),
    },
  ],
});
</script>
