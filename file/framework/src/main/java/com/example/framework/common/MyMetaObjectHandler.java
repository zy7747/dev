...
public class MyMetaObjectHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        strictInsertFill(metaObject, "creator", String.class, ServletUtils.getLoginUserId());
    }
    ...
    public void updateFill(MetaObject metaObject) {
        ...
        strictUpdateFill(metaObject, "updater", String.class, ServletUtils.getLoginUserId());
    }
}